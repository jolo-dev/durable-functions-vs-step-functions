import{SESClient as m,SendEmailCommand as l}from"@aws-sdk/client-ses";import{DynamoDBClient as c,PutItemCommand as u}from"@aws-sdk/client-dynamodb";var p=new m({}),f=new c({}),E=async n=>{let{email:e}=n;if(!e)throw new Error("Missing required fields: to, requestId, code");let s=new Date().toISOString(),r="Demo: Your Verification Code",o=Math.floor(1e5+Math.random()*9e5).toString(),i=`Here is your Code: ${o}`,a=`
    <html>
