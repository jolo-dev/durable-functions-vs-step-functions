import{SESClient as m,SendEmailCommand as c}from"@aws-sdk/client-ses";import{DynamoDBClient as u,PutItemCommand as p}from"@aws-sdk/client-dynamodb";var f=new m({}),y=new u({}),s=async t=>{let{email:e}=t;if(!e)throw new Error("Missing required fields: to, requestId, code");let o=new Date().toISOString(),n="Demo: Your Verification Code",r=Math.floor(1e5+Math.random()*9e5).toString(),a=`Here is your Code: ${r}`,d=`
    <html>
